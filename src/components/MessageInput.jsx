...
import { InputGroup, Textarea, Input } from '@chakra-ui/react'
...
const MessageInput = () => {
    return (
        <div className='bg-[#FFF] font-semibold text-[16px] text-text flex items-center gap-x-[10px] md:px-[50px] px-[20px] h-[70px]'>
            ...
            <Input placeholder='Type something...' variant='unstyled' className='md:text-[18px] text-[14px]'/>
            <MdSend size={30} className='cursor-pointer' />
        </div>
    )
}
