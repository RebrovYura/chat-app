...
const Login = () => {
    ...
    return (
        <div className='form font-poppins bg-primary min-h-[100vh] flex justify-center items-center'>
            <div className='formWrapper bg-white px-[40px] py-[30px] rounded-[10px] max-w-[335px]'>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-[25px]'>
                    <input type="email" placeholder='Email' className='px-[10px] py-[8px] rounded-[8px] outline-none bg-primary text-text focus:bg-primary transition' />
                    <input type="password" placeholder='Password' className='px-[10px] py-[8px] rounded-[8px] outline-none bg-primary text-text focus:bg-primary transition' />
